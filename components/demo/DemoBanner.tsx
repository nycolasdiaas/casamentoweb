...
export default function DemoBanner({ pkg }: { pkg: WeddingPackage }) {
  return (
    <div className="sticky top-0 z-40 bg-(--c-ink) text-white px-4 py-3 flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-center">
      ...
      <Link
        href="/"
        className="font-serif text-xs underline underline-offset-2 hover:text-(--c-mark)"
      >
